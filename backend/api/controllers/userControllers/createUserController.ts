...
// createUser - creates user (composer as default), create's users's profile,
// and then updates users's userProfileID
exports.createUser = async (req, res) => {
  // incoming: uid, username, email
  ...
  var sqlInsert =
    "INSERT INTO user(uid, isPublisher, username, email) VALUES(?,?,?,?)";
