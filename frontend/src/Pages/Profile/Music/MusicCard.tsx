    ...
    <div className="card">
      ...
      >
        ...
        >
          ...
          <p className="card-text-secondary" style={{ margin: "0%" }}>
            {showMore || !description || description.length <= 250
              ? description
