...
const genreStyle = { position: 'relative', backgroundColor: DefaultValues.secondaryColor + "4A", alignItems: "center", display: "flex", justifyContent: "center", verticalAlign: "middle" };
...
const style2 = { position: 'absolute', height: paperStyle.innerSize, width: paperStyle.innerSize, borderRadius: '10px' };
