...
export const style = { position: 'relative', backgroundColor: DefaultValues.primaryColor, height: paperStyle.paperSize, width: paperStyle.paperSize, borderRadius: '25px' };
...
export const style3 = { cursor: 'default', backgroundColor: DefaultValues.black + "CC", height: '3rem', borderRadius: '10px' };
