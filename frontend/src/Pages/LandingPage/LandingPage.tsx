        ...
        <>
            <div style={{ height: "100vh" }} className="bg">
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <h1 style={{ margin: "2%" }}>Composition Today</h1>
                    <div style={{ display: "flex", flex: "1 0 0", justifyContent: "flex-end", alignItems: "center" }}>
                        ...
                        <h1 style={{ margin: "2%", cursor: "pointer" }} onClick={() => navigate('/registration')}>Log in</h1>
                    </div>
                </div>
                <div style={{ position: "absolute", marginLeft: "2%", marginTop: "26%", width: "25%" }}>
                    <h1 style={{ marginBottom: "6%" }}>Welcome to Composition Today!</h1>
                    <h2>A hub for musicians to connect with publishers and with each other</h2>
                </div>
